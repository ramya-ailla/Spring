...
import com.spring.AOPAfterFinallyAdvicedemo.Account;
...
public class MyDemoLoggingAspect {
    ...
    @AfterReturning(
            pointcut = "execution(* com.spring.AOPAfterFinallyAdvicedemo.dao.AccountDAO.findAccounts(..))",
            returning = "result")
    ...
    @After("execution(* com.spring.AOPAfterFinallyAdvicedemo.dao.AccountDAO.findAccounts(..)))")
