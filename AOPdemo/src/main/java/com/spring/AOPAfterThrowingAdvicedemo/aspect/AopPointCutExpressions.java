...
public class AopPointCutExpressions {
    @Pointcut("execution(* com.spring.AOPAfterThrowingAdvicedemo.dao.*.*(..))")
    public void forDaoPackage() {}

    //create pointcut for getter methods
    @Pointcut("execution(* com.spring.AOPAfterThrowingAdvicedemo.dao.*.get*(..))")
    public void forDaoPackageGetters() {}

    //create pointcut for setter methods
    @Pointcut("execution(* com.spring.AOPAfterThrowingAdvicedemo.dao.*.set*(..))")
